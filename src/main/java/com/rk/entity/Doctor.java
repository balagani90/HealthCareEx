...
public class Doctor {
	...
	public Doctor(Long id, String firstName, String lastName, String email, String address, String mobile,
			String gender, String note, String photoLoc, com.rk.entity.Specialization specialization) {
		super();
		this.id = id;
